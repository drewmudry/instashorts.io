    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          <div className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl rounded-2xl shadow-xl border border-black/10 dark:border-white/10 p-8">
            {/* Header */}
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white/90 dark:bg-zinc-900/90 text-zinc-500 dark:text-zinc-400">
          ...
          <div className="mt-6 text-center">
            <button
              onClick={() => router.push('/')}
              className="text-sm text-black/70 dark:text-white/70 hover:text-black dark:hover:text-white transition-colors font-medium"
            >
              ← Back to home
            </button>
          </div>
